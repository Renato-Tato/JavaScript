!(function (n, r) {
  ...
  function mr(n, r, t) {
    r = Fn(r, t);
    for (
      var e = !rr(n) && nn(n), u = (e || n).length, i = Array(u), o = 0;
      o < u;
      o++
    ) {
      var a = e ? e[o] : o;
  ...
  var Mr = j(function (n, r, t) {
    ...
    return (
      D(r)
        ? (u = r)
        : ((r = En(r)), (e = r.slice(0, -1)), (r = r[r.length - 1])),
      mr(n, function (n) {
        var i = u;
        if (!i) {
  ...
  function Gr(n) {
    for (var r = (n && Br(n, Y).length) || 0, t = Array(r), e = 0; e < r; e++)
      t[e] = Er(n, e);
    return t;
  }
  var Hr = j(Gr);
  ...
  var Yr = Xr({
    ...
    isEqual: function (n, r) {
      for (var t = [{ a: n, b: r }], e = [], i = []; t.length; ) {
        ...
        if (!0 !== o) {
          ...
          var f = typeof n;
          if ("function" !== f && "object" !== f && "object" != typeof r)
            return !1;
          (n instanceof tn && (n = n._wrapped),
    ...
    template: function (n, r, t) {
      ...
      var e = RegExp(
          [
            (r.escape || Kn).source,
            (r.interpolate || Kn).source,
            (r.evaluate || Kn).source,
          ].join("|") + "|$",
          "g",
        ),
        u = 0,
